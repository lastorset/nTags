{* 
 * A version of design/admin/templates/children.tpl from eZ publish 4.1.3.
 * Modified by nTags to support tags view for node children.
 *}
...
<div class="right">
        ...
        <span class="current">{'Tags'|i18n( 'design/admin/node/view/full' )}</span>
        {/case}
        ...
        <a href={'/user/preferences/set/admin_children_viewmode/detailed'|ezurl} title="{'Display sub items using a detailed list.'|i18n( 'design/admin/node/view/full' )}">{'Detailed'|i18n( 'design/admin/node/view/full' )}</a>
        <a href={'/user/preferences/set/admin_children_viewmode/tags'|ezurl} title="{'Display sub items with tags.'|i18n( 'design/admin/node/view/full' )}">{'Tags'|i18n( 'design/admin/node/view/full' )}</a>
        {/case}
...
{case match='tags'}
    {include uri='design:children_tags.tpl'}
{/case}
